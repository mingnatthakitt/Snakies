...
class_labels = ['Asian coral snakes', 'Asian keelbacks', 'Bamboo snakes', 'Bearded snakes', 'Blind snakes', 'Blunt-headed tree snake', 'Bockadams', 'Bronzebacks', 'Brown snakes', 'Cat snakes', 'Cobras', 'Collared snakes', 'Crab-eating snakes', 'Dragon snakes', 'Estuarine snakes', 'Green pit vipers', 'Ground snakes', 'Keelbacks', 'King cobra', 'Kraits', 'Kukri snake', 'Long-glanded coral snakes', 'Mangrove snakes', 'Mock vipers', 'Mountain keelbacks', 'Mountain pit vipers', 'Mountain reed snakes', 'Mountain snakes', 'Mountain stream snakes', 'Mud snakes', 'Olive sea snakes', 'Pipe snakes', 'Pit vipers', 'Pythons', 'Racers', 'Rat snakes', 'Reed snakes', 'Sand snakes', 'Sea kraits', 'Sea snakes', 'Slug-eating snakes', 'Smooth snakes', 'Sunbeam snakes', 'Tentacled snake', 'Tree snakes', 'True vipers', 'Wart snakes', 'Whip snakes', 'Wolf snakes & bridle snakes']
